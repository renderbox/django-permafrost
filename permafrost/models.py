...
class PermafrostRole(models.Model):
    ...
    site = models.ForeignKey(Site, on_delete=models.CASCADE, default=get_current_site, related_name="permafrost_roles")           # This uses a callable so it will not trigger a migration with the projects it's included in
